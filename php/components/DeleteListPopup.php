...
<div class="modal fade" id="DeleteListPopup" tabindex="-1" aria-labelledby="DeleteListTitle" aria-hidden="true" style="color:black">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DeleteListTitle">Delete List</h5>
